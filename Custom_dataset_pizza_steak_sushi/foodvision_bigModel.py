...
def main():
    ...
    if not os.path.exists(MODEL_SAVE_PATH):
        ...
        train_data_food101_20_percent,_ = split_dataset(dataset=train_dataset,
                                                        split_size=0.2)
        # Create testing 20% split Food101
        test_data_food101_20_percent,_ = split_dataset(dataset=test_dataset,
                                                        split_size=0.2)
    ...
    if ask == 'y':
        ...
        for example in foodvision_big_examples:
            ...
            shutil.copy2(src=example,
                        dst=destination)
        effnetb2_foodvision_big_model_path = 'Models/EffNetB2_Food101.pth'
